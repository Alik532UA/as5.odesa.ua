...
content = content.replace(
	`	const galleryImages = [
		{ src: '/static/departments/folk.png', alt: 'Gallery Image 1', title: 'Folk Music Exhibit' },
		{ src: '/static/departments/piano.png', alt: 'Gallery Image 2', title: 'Piano Recital Photo' },
		{ src: '/static/departments/pop.png', alt: 'Gallery Image 3', title: 'Pop Music Performance' },
		{ src: '/static/departments/strings.png', alt: 'Gallery Image 4', title: 'Strings Ensemble' },
		{ src: '/static/departments/theory.png', alt: 'Gallery Image 5', title: 'Music Theory Workshop' },
		{ src: '/static/departments/vocal.png', alt: 'Gallery Image 6', title: 'Vocal Performance' },
	];`,
	`	const galleryImages = [
...
content = content.replace(
	`		.gallery-grid, .gallery-masonry, .gallery-dynamic-grid { grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); }
		.gallery-item img, .gallery-item-masonry img, .gallery-item-carousel img { height: 180px; }
		.gallery-item-carousel { flex-basis: 250px; }
...
content = content.replace(
	`		.gallery-grid, .gallery-masonry, .gallery-dynamic-grid { grid-template-columns: 1fr; }
		.gallery-item-carousel { flex-basis: 280px; }
...
const newHtml = `<!-- Modern Gallery Section -->
...
const newCss = `/* === Modern Gallery Section Styles === */
	.g-showcase {
		padding: 6rem 0;
...
content = content.replace('<!-- Gallery Section -->', newHtml + '<!-- Gallery Section -->');
content = content.replace('/* === Gallery Section Styles === */', newCss + '/* === Gallery Section Styles === */');
