<script lang="ts">
	 ...
	 *
	 * **Жести живуть у `ServiceLayer`, а не тут** — бо в проді цей компонент не
	 * відмальований, доки жест не спрацював, тож слухач усередині нього не міг би
	 * дочекатися жесту, який його ж і показує. (Спершу вони жили в шапці; разом із
	 * рештою клавіш переїхали в шар, який тримає і їх, і це табло.)
	 */
