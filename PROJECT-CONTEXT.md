...
| `npm test` | CI | **15 файлів, 102 перевірки** (`npx vitest run \| grep "Tests "`) |
...
Файли інваріантів: `ci`, `contrast`, `css-variables`, `error-logger-reachable`,
...
Він лежить поза `src/` навмисно: у бандл не входить і для `structure.test.ts`
не виглядає осиротілим модулем застосунку.
...
|---|---|---|---|
| `src/routes/test/+page.svelte` | 1436 | 400 | 1436 |
