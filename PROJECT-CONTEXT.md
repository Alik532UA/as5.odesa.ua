...
| ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| E2E-**сценарії**                                                  | Playwright стоїть із 2026-08-23, але **лише під axe**: у `tests/` рівно один файл. Користувацьких сценаріїв ним не покрито                                                               | додавати свідомо, а не «бо Playwright же є»   |
| ~~axe-аудит a11y~~                                                | **Закрито 2026-08-23.** `tests/a11y.spec.ts` — головна й чеклист, у світлій і темній темі, порт 5499. Перший прогін знайшов два справжні дефекти контрасту (див. «Що тепер перевіряється») | —                                             |
...
| Контраст на напівпрозорому тлі, `color-mix`, градієнтах           | `contrast.test.ts` бере лише пари, де обидва боки — токени тем; решта в його ж звіті названа числом (130 непокритих). Частину цього борга axe уже закриває — саме там він і знайшов обидва дефекти, — але лише на двох сторінках із восьми | розширити перелік сторінок axe                |
